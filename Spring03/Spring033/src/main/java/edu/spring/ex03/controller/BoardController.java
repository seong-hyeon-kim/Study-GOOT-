...
//		}
	...
	public String registerPOST(BoardVO vo, RedirectAttributes reAttr) {
		...
		if(result == 1) {
			...
			return "redirect:/board/register"; // /board/register 경로로 이동.
		}
	...
	@PostMapping("/delete")
	public String deletePOST(Integer boardId) {
		logger.info("deletePOST() 호출 : boardId = " + boardId);
